    ...
    <style>
       ...
       *{
        ...
        .inp{
            ...
            /* -webkit-box-shadow: -1px 1px 30px -11px 20% #303779;
            -moz-box-shadow: -1px 1px 30px -11px #303779;
            box-shadow: -1px 1px 30px -11px #303779; */
        }
        .btn1{
            height:50px;
            width:50%;
  ...
  <body >
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST'){
                ...
                if (!$conn){
                    ...
                    // $sql = "INSERT INTO `users` (`Name`, `Email Id`, `Gender`, `Balance`) VALUES (?,?,?,?)";
